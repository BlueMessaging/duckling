(defproject com.bm/duckling "0.4.10"
  ...
  :deploy-repositories [["nexus-release" 
                          {:url "http://184.73.254.191/nexus/content/repositories/thirdparty/" :creds :gpg}
                        ]
                       ]
